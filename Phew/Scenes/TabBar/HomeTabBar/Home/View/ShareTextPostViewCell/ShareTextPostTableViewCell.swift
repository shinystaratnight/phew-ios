//
//  ShareTextPostTableViewCell.swift
//  Phew
//
...
import UIKit
class ShareTextPostTableViewCell: UITableViewCell {
...
//        }
    ...
    var item:HomeModel!{
        didSet{
            ...
            if let name = item.user?.fullname?.components(separatedBy: " ").first {
                lblNmaeUser.text = "Echoed back by " + name
            }
...
extension ShareTextPostTableViewCell:UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
